...
class V1beta1_Endpoints(object):
    """
    ...
    def __init__(self):
        self.swaggerTypes = {
            ...
            'targetRefs': 'list[V1beta1_EndpointObjectReference]',
        ...
        #list of endpoints corresponding to a service, of the form address:port, such as 10.10.1.1:1909
        
        self.endpoints = None # list[str]
        ...
        #IP protocol for endpoint ports; must be UDP or TCP; TCP if unspecified
        ...
        self.targetRefs = None # list[V1beta1_EndpointObjectReference]
