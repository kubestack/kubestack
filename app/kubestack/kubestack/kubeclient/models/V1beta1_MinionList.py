...
class V1beta1_MinionList(object):
    """
    ...
    def __init__(self):
        self.swaggerTypes = {
            ...
            'items': 'list[V1beta1_Minion]',
            
            
            'kind': 'str',
            
            
            'minions': 'list[V1beta1_Minion]',
        ...
        self.items = None # list[V1beta1_Minion]
        
        #kind of object, in CamelCase; cannot be updated
        
        self.kind = None # str
        
        #list of nodes; deprecated
        
        self.minions = None # list[V1beta1_Minion]
