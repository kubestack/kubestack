...
class V1beta1_Namespace(object):
    """
    ...
    def __init__(self):
        self.swaggerTypes = {
            ...
            'labels': 'V1beta1_Namespace_labels',
            ...
            'spec': 'V1beta1_NamespaceSpec',
            
            
            'status': 'V1beta1_NamespaceStatus',
        ...
        #map of string keys and values that can be used to organize and categorize namespaces
        
        self.labels = None # V1beta1_Namespace_labels
        ...
        self.spec = None # V1beta1_NamespaceSpec
        
        #status describes the current status of a Namespace; read-only
        
        self.status = None # V1beta1_NamespaceStatus
