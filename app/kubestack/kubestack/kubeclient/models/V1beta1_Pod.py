...
class V1beta1_Pod(object):
    ...
    def __init__(self):
        self.swaggerTypes = {
            ...
            'labels': 'V1beta1_Pod_labels',
            
            
            'namespace': 'str',
            
            
            'nodeSelector': 'V1beta1_Pod_nodeSelector',
        ...
        #current state of the pod; populated by the system, read-only
        
        self.currentState = None # V1beta1_PodState
        ...
        #map of string keys and values that can be used to organize and categorize pods; may match selectors of replication controllers and services
        
        self.labels = None # V1beta1_Pod_labels
        ...
        self.nodeSelector = None # V1beta1_Pod_nodeSelector
